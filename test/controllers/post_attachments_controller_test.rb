...
class PostAttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_attachment" do
    assert_difference('PostAttachment.count') do
      post post_attachments_url, params: { post_attachment: { file: @post_attachment.file, post_id: @post_attachment.post_id } }
    end
  ...
  test "should update post_attachment" do
    patch post_attachment_url(@post_attachment), params: { post_attachment: { file: @post_attachment.file, post_id: @post_attachment.post_id } }
